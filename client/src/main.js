...
const floor = new THREE.Mesh(new THREE.PlaneGeometry(520, 520), new THREE.MeshStandardMaterial({ color: 0x67b7e6, metalness: 0.04, roughness: 0.55 }));
floor.rotation.x = -Math.PI / 2;
floor.receiveShadow = true;
scene.add(floor);
const island = new THREE.Mesh(new THREE.CylinderGeometry(98, 116, 20, 48), new THREE.MeshStandardMaterial({ color: 0x957b58, roughness: 0.96 }));
island.position.y = -8;
scene.add(island);
const grassPlateau = new THREE.Mesh(new THREE.CircleGeometry(96, 64), new THREE.MeshStandardMaterial({ color: 0x5f8b4b, roughness: 0.95 }));
grassPlateau.rotation.x = -Math.PI / 2;
grassPlateau.position.y = 0.22;
scene.add(grassPlateau);
...
const wallS1 = new THREE.Mesh(new THREE.BoxGeometry(33.5, 22, 1.2), wallMat); wallS1.position.set(-23.2, 11, 39.4);
const wallS2 = new THREE.Mesh(new THREE.BoxGeometry(33.5, 22, 1.2), wallMat); wallS2.position.set(23.2, 11, 39.4);
const wallW = new THREE.Mesh(new THREE.BoxGeometry(1.2, 22, 80), wallMat); wallW.position.set(-39.4, 11, 0);
const wallE = new THREE.Mesh(new THREE.BoxGeometry(1.2, 22, 80), wallMat); wallE.position.set(39.4, 11, 0);
...
const roof = new THREE.Mesh(new THREE.BoxGeometry(82, 2.6, 82), roofMat); roof.position.y = 22.6;
